<template>
 ...
 <h1 class="text-3xl font-bold mb-6 text-center text-gray-900 ">Devenir Vendeur sur GadgetZone</h1>
...
const submitApplication = async () => {
 ...
 return; // Don't proceed to the next block as we handle it in onConfirm
 } else {
